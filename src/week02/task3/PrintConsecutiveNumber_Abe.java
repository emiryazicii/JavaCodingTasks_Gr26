...
For example, numbers divisible by both 2 and 3 should be replaced by CodilityTest and numbers divisible by all three numbers:
...
17
 */
public class PrintConsecutiveNumber_Abe {
